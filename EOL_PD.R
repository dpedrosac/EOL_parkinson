...
# ==================================================================================================
# Generic function to print AUC for the estimated models
#
...
# ==================================================================================================
# Print results in separate subfigures #TODO: move below function to make it work
...
save(list = c("CI_full", "CI_step", "CI_pen"),
	 file = file.path(wdir, "results", "CIdataBootstrap.Rdata"))
